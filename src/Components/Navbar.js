...
function Navbar() {
  return (
    <Box sx={{ flexGrow: 1, background: 'linear-gradient( #7900D2, black 80%)'
        ...
        <AppBar position="static" sx={{width:'90%', height:'65px', borderRadius:'40px', backgroundColor:'black', display:'flex', justifyContent:'center'}}>
          <Toolbar>
          ...
          />  
            ...
            <Link to="/contact" className='ubuntu-regular' style={{ textDecoration: 'none', color: 'inherit', marginLeft: '20px' }}>
              <Typography variant="h7" sx={{border:'2px solid #7900D2', padding:'10px', borderRadius:'40px', fontWeight:'500', color:'#7900D2', fontSize: { xs: '0.8rem', md: '1rem' }}}
               onMouseEnter={(event) => {
