    ...
    function Services() {
        return (
            <Box sx={{height:'100%', pt: '64px', backgroundColor: '#2A0148', color: 'black' }}>
                ...
                <Typography className='ubuntu-regular' variant="h2" component="h1" gutterBottom sx={{color:'white', fontFamily: 'Ubuntu, sans-serif', fontWeight:'500', fontSize: { xs: '2rem', md: '3rem' } }}>
                        Our Services
                    </Typography>
